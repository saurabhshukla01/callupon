      ...
      <header id="header">
         ...
         <div class="container">
            <div class="logo float-left">
               ...
               <h1 class="text-light"><a href="/" class="scrollto"><span><img src="<?php base_url();?>/assets/img/callupon_logo.png" /></span></a></h1>
               <!-- <a href="#header" class="scrollto"><img src="<?php base_url();?>/assets/img/logo.png" alt="" class="img-fluid"></a> -->
            </div>
         ...
         <div class="container d-flex h-100">
            <div class="row justify-content-center align-self-center">
               <div class="col-md-6 intro-info order-md-first order-last">
                  <h2>Petition Solutions<br>for Your <span>Business!</span></h2>
                  <div>
