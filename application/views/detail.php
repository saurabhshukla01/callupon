...
?></span></p> 
                  <?php } ?>
                  <p> <button type="button" class="btn btn-primary" onclick="javascript:post_on_facebook();">Share on Facebook</button></p>
                  <!--<p><a href="javascript:poptastic('<?php echo $twitter_url; ?>');">Tweet to your followers</a></p>-->
                  <p><a href="javascript:void(0);" class="fa fa-twitter" onclick="javascript:post_on_twitter('<?php echo $twitter_url; ?>');">Tweet to your followers</a></p>
                  <p><a href="javascript:void(0);" onclick="javascript:copyLink();" class="fa fa-link" >Copy Link</a></p>
